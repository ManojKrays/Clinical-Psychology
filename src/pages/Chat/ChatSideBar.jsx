...
const ChatSideBar = ({ setSidebarOpen, menuItems, sidebarOpen, handleLogout }) => {
    const navigate = useNavigate();

    return (
        <>
            <div
                className={`bg-secondary font-avenir fixed z-50 h-[100dvh] max-w-xs shadow-lg transition-transform duration-300 md:static md:flex md:w-[20%] md:translate-x-0 ${
                ...
                <div className="flex h-[100dvh] w-full flex-col justify-between">
                    <div>
                        <div className="flex items-center space-x-3 p-4 pb-5 md:flex-col lg:flex-row">
                            ...
                            <div>
                                <h1 className="text-lg font-bold text-white">Zara AI</h1>
                                <p className="text-xs text-indigo-100">Your AI Mentor!</p>
                            </div>
                        </div>
